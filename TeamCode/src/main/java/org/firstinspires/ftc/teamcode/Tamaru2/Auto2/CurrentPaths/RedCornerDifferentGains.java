...
@Autonomous
@Disabled
public class RedCornerDifferentGains extends LinearOpMode {
    ...
    //tested at voltage of 12.5
    public static double py = 0.5, iy = 0.05, dy = 0.08;
    public static double fy = 0;
    public static double px = 0.6, ix = 0.1, dx = 0.075;
    public static double fx = 0;
    public static double pTheta = 2.5, iTheta = 0.01, dTheta = 0.15;
    public static double fTheta = 0;

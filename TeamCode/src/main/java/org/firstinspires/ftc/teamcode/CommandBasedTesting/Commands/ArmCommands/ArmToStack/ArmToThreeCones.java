...
public class ArmToThreeCones extends CommandBase {
    ...
    public ArmToThreeCones(LinearArmSubsystem arm, TurretSubsystem turret, ExtensionSubsystem extension) {
        tamaruArm = arm;
        tamaruTurret = turret;
    ...
    @Override
    public void execute() {
        tamaruArm.setArmToHeight(LinearArmSubsystem.Height.THREE_CONES);

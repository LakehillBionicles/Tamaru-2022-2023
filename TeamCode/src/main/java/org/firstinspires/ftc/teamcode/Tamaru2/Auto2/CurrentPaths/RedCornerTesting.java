...
@Autonomous
@Disabled
public class RedCornerTesting extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        while(opModeIsActive()) {
            ...
            Control(60, 0, 0, midPoleArmTarget, robot.turretForward, 0, robot.handClosed, 1.5);
            Control(44, 0, 0, midPoleArmTarget, robot.turretForward, 0, robot.handClosed, 1);
            ...
            Control(57, 0, 0, fiveConeArmTarget, robot.turretForward, 0, robot.handOpen, 1.5);
            PIDDriveControl(57, 0, -90, 1.5);
            ...
            robot.servoExtend.setPosition(0);
            //sleep(1000);//was 1500
            //Drive to furthest parking (to check on time)
            PIDDriveControl(36, 0, -90, 1);*/

...
@Disabled
@Autonomous
public class MazeTest2 extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence maze = drive.trajectorySequenceBuilder(new Pose2d())
                ...
                .turn(Math.toRadians(90))
                .splineToLinearHeading(new Pose2d(8, 26, Math.toRadians(0)), Math.toRadians(0))
                .turn(Math.toRadians(-90))
                .splineToLinearHeading(new Pose2d(8, 40, Math.toRadians(0)), Math.toRadians(0))
                .turn(Math.toRadians(-90))
        ...
        /*TrajectorySequence mazeReverse = drive.trajectorySequenceBuilder(maze.end())
                .splineToLinearHeading(new Pose2d(8, 40, Math.toRadians(0)), Math.toRadians(0))
                .turn(Math.toRadians(90))
                .splineToLinearHeading(new Pose2d(8, 26, Math.toRadians(90)), Math.toRadians(0))
                .turn(Math.toRadians(90))
                .splineToLinearHeading(new Pose2d(40, 20, Math.toRadians(180)), Math.toRadians(0))
                .turn(Math.toRadians(90))
                .splineToLinearHeading(new Pose2d(40, 6, Math.toRadians(90)), Math.toRadians(0))
                .turn(Math.toRadians(-90))
                .splineToLinearHeading(new Pose2d(5, -4, Math.toRadians(0)), Math.toRadians(0))
                .turn(Math.toRadians(-90))
                .build();*/

...
@Config
@TeleOp
public class PIDTestAllVelocity extends OpMode{
    ...
    public void loop(){
        ...
        double yVelocity = -pidY * robot.maxVelocity;
        double xVelocity = -pidX * robot.maxVelocity;
        double thetaVelocity = -pidTheta * robot.maxVelocity;

        robot.fpd.setVelocity(yVelocity - xVelocity + thetaVelocity);
        robot.bpd.setVelocity(yVelocity + xVelocity + thetaVelocity);
        robot.fsd.setVelocity(yVelocity + xVelocity - thetaVelocity);
        robot.bsd.setVelocity(yVelocity - xVelocity - thetaVelocity);

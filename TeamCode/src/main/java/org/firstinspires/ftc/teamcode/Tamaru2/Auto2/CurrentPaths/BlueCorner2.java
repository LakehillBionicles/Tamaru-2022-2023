...
public class BlueCorner2 extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        while(opModeIsActive()) {
            ...
            //probably less
            Control(42.25, 0, 0, midPoleArmTarget, robot.turretForward, 0, robot.handClosed, 1, true, false, false);
            ...
            Control(54.5, 0, 0, fiveConeArmTarget, robot.turretForward, 0, robot.handOpen, 2, false, false, false);//2
            PIDDriveControl(54.5, 0, 90, 1.5, false, false, false);
            ...
            //probably more
            PIDDriveControl(62.5, 0, 90, 1.5, false, true, false);//67.5
            robot.servoTurret.setPosition(robot.turretStar);
            robot.servoExtend.setPosition(.475);
            sleep(1500);
            robot.servoHand.setPosition(robot.handOpen);
            sleep(1000);
            ...
            PIDDriveControl(62.5, 0, 90, 1.5, false, true, false);
            robot.servoTurret.setPosition(robot.turretStar);
            robot.servoExtend.setPosition(.475);
            sleep(1500);
            robot.servoHand.setPosition(robot.handOpen);
            ...
            if(color=="green"){
                ...
                PIDDriveControl(50, 0, 90, 1, false, false, false);
            }else{

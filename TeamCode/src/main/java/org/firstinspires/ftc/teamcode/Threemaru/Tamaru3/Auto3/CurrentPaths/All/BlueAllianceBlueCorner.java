package org.firstinspires.ftc.teamcode.Threemaru.Tamaru3.Auto3.CurrentPaths.All;
...
@Disabled
@Config
@Autonomous(name = "BlueAllianceBlueCorner", group = "All")
public class BlueAllianceBlueCorner extends AutoBase {
    ...
    public void runOpMode(){
        ...
        TrajectorySequence ScorePreload = drive.trajectorySequenceBuilder(startPose)
                ...
                .addTemporalMarker(.5, () -> {turretToPosition(robot.turretPort); extensionToPosition(robot.extensionPort); robot.servoHand.setPosition(robot.handClosed);})
        ...
        TrajectorySequence Score1B = drive.trajectorySequenceBuilder(startPose)
                .addDisplacementMarker(() -> armToPosition(midPoleArmTarget)) //arm to low pole
                .addTemporalMarker((1), () -> { turretToPosition(robot.turretStar);})
        ...
        lineUpWithConeStackPickUpLeft("blue");
        ...
        robot.servoExtend.setPosition(Math.max(1.45 + -0.145 * distStar + 4.76E-04 * distStar * distStar, .5));

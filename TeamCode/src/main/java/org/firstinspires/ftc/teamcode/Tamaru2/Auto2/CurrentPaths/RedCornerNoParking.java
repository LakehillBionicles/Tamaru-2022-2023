...
@Autonomous
@Disabled
public class RedCornerNoParking extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        while(opModeIsActive()) {
            ...
            Control(24, 0, 0, midPoleArmTarget, robot.turretForward, 0, robot.handClosed, 1.5);
            Control(44, 0, 0, midPoleArmTarget, robot.turretForward, 0, robot.handClosed, 2.5);

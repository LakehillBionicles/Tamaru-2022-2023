...
public class RedCornerParking extends AutoBase2{
    ...
    public void runOpMode(){
        ...
        telemetry.addData("color", senseColorsStar());
        telemetry.update();
        ...
        /*if(senseColorsStar().equals("green")){
            sinDrive(0, -10, 0, .35, .5, .3, 2, 2, 1);
            sinDrive(-24, 0, 0, .75, .3, .3, 2.5, 2, 2);
            telemetry.addData("parked", "green");
            telemetry.update();
        }else if(senseColorsStar().equals("blue")){
            sinDrive(0, -12, 0, .35, .75, .35, 1, 1, 1);
            telemetry.addData("parked", "blue");
            telemetry.update();
        }else{
            sinDrive(0, -10, 0, .35, .75, .35, 2, 2, 1);
            sinDrive(22, 0, 0, .75, .35, .35, 2, 2, 1);
